...
class PME:
    def __init__(self, input_df, initial_wait_order_queue={}, initial_fill_order=[]):
        self.input_order_df = input_df
        self.initial_worder_queue = initial_wait_order_queue
        self.initial_forder_list = initial_fill_order
        self.output = standard_oi(self.input_order_df)

    def standard_oi(self):
        output_df = copy.deepcopy(self.input_order_df)
        ...
        input_flow = self.input_order_df.loc[self.input_order_df['OrderQuantity'] <= 1000000].values.tolist()
        output_lists = price_match(copy.deepcopy(input_flow), self.initial_worder_queue, self.initial_forder_list)
...
if __name__ == '__main__':
    ...
    output_a = PME(sample_a).output
    output_b = PME(sample_b).output
    output_c = PME(sample_c).output
    output_d = PME(sample_d).output
    output_e = PME(sample_e).output
    print(output_a)
    print(output_b)
    print(output_c)
    print(output_d)
